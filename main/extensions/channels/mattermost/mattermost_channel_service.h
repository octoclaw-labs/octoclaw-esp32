#ifndef OCTO_MATTERMOST_CHANNEL_SERVICE_H
#define OCTO_MATTERMOST_CHANNEL_SERVICE_H
...
class MattermostChannelService {
public:
    static MattermostChannelService& GetInstance();
...
private:
    MattermostChannelService() = default;
    ...
    RuntimeStats stats_;
    std::vector<MattermostInboxMessage> inbox_;
};

}  // namespace octo::channels

#endif  // OCTO_MATTERMOST_CHANNEL_SERVICE_H
